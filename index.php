...
if ($requestMethod === 'GET' && isset($_GET['sub']) && $_GET['sub'] === "true") {
    ...
    <div class="container-fluid">
        ...
        <div class="row mh-100vh">
            ...
            <div class="col-lg-6 d-flex align-items-end" id="bg-block"
                 style="background-image: url(&quot;https://images.assetsdelivery.com/compings_v2/auxins/auxins2302/auxins230200611.jpg&quot;);background-size: cover;background-position: center center;">
