...
VALUES ('admin1', '$2y$10$TOBO0ipevsQEWJ7oME7iEegjPT7s3HL9K5PJB.qIiXwj1ED2ZhvTi'),
...
INSERT INTO vehicules (marque, modele, annee, client_id)
VALUES ('Toyota', 'Camry', 2015, 1),
       ('Honda', 'Civic', 2020, 2),
       ('Ford', 'Focus', 2018, 3);


INSERT INTO rendezvous (date_heure, vehicule_id, description)
VALUES ('2023-12-01 10:00:00', 1, "Entretien régulier"),
...
VALUES (1, 'abcdef12faketoken3456', '2023-12-31 23:59:59');